...
# Astar
## Overview
This project was created for the Eurobot 2025 and 2026 contest and it is an implementation of the Astar pathfinding algorithm. In the context of the contest it was used to help the robot navigate the playable area when it encountered
...
This implementation features an automatic point generation method. The user chooses only the lenght and width of the grid and the algorithm uses them to create an imaginery grid of the area. This reduces by a lot the memory needed because you don't physically store the grid.
### 2. Step mechanism
